...
NewEntryDialog::NewEntryDialog(wxWindow* parent)
    : wxDialog(parent, -1, "New Password Entry", wxDefaultPosition, wxSize(450, 380)) {
    ...
    // Password
    hSizer = new wxBoxSizer(wxHORIZONTAL);
    hSizer->Add(new wxStaticText(this, -1, "Password:"), 0, wxALIGN_CENTER_VERTICAL | wxRIGHT, 8);
    passwordCtrl = new wxTextCtrl(this, -1, "", wxDefaultPosition, wxDefaultSize, wxTE_PASSWORD);
    hSizer->Add(passwordCtrl, 1, wxEXPAND);
    mainSizer->Add(hSizer, 0, wxEXPAND | wxALL, 5);
